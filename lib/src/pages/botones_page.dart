  ...
  Widget _titulos() {
    ...
    return SafeArea(
      child: Padding(
        ...
        child: Container(
          child: Text("COVENANTS", style: Titulo, textAlign: TextAlign.center),
        ),
      ),
    );
      ...
      children: [
        TableRow(children: [
          _crearBotonRedondeado(
              Colors.blue, Icons.border_all, 'General', context, 'scroll'),
          _crearBotonRedondeado(
              Colors.red, Icons.directions_bus, 'Bus', context, 'covenants'),
        ]),
        TableRow(children: [
          _crearBotonRedondeado(
              Colors.greenAccent, Icons.shop, 'Buy', context, 'covenants'),
          _crearBotonRedondeado(Colors.lightBlueAccent, Icons.insert_drive_file,
              'File', context, 'basico'),
        ]),
